...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
 ...
 [_WM] = LAYOUT_ortho_5x15( /* WORKMAN */
    ...
    _______,    KC_Q,    KC_D,    KC_R,    KC_W,    KC_B, _______, _______, _______,    KC_J,    KC_F,    KC_U,    KC_P, _______, _______, \
 ...
 [_FN] = LAYOUT_ortho_5x15( /* FUNCTION */
	_______,         KC_F1,       KC_F2,   KC_F3,   KC_F4,   KC_F5, KC_INS,  MO(_DB), KC_PSCR,   KC_F6,   KC_F7,   KC_F8,   KC_F9,      KC_F10,  KC_F11, \
    ...
    _______,       _______,     _______, _______, _______, _______, KC_DEL,  _______, KC_RALT, KC_PCMM, KC_VOLD, KC_MUTE, KC_MPLY,     KC_VOLU,  KC_END, \
    _______,       _______,     _______, _______, _______, _______, KC_BSPC, _______,  KC_ESC, KC_PMNS, KC_BRID, KC_PGDN, KC_PGUP,     KC_BRIU, _______  \
 ),
